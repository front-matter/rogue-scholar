  ...
  ReactDOM.render(
    <OverridableContext.Provider value={overriddenComponents}>
      <RecordManagement
        ...
        recordDeletion={JSON.parse(
          recordManagementAppDiv.dataset.recordDeletion,
        )}
...
if (sidebarCommunitiesManageDiv) {
  ...
  const permissions = JSON.parse(
    sidebarCommunitiesManageDiv.dataset.permissions,
  );
  const record = JSON.parse(sidebarCommunitiesManageDiv.dataset.record);
  const recordRequests = JSON.parse(
    sidebarCommunitiesManageDiv.dataset.recordRequests,
  );
  ReactDOM.render(
    <OverridableContext.Provider value={overriddenComponents}>
      <Overridable
