...
url = "https://rogue-scholar.org/api/communities?type=topic&size=1"
response = httpx.get(url)
result = response.json()
...
{{< iconify fluent:people-community-16-regular size=4x >}}

:::: {.h5}
Topic Communities

::::: {.display-4}
[`{python} topic_count`](https://rogue-scholar.org/communities/search?q=&f=type%3Atopic&l=list&p=1&s=10&sort=newest)
:::::
::::
:::
...
::::: {.display-4}
[`{python} post_funding_count`](https://rogue-scholar.org/search?q=funding:*&l=list&p=1&s=10&sort=newest)
:::::
::::
:::
...
::: {.card .full-text}
{{< iconify bi:tags size=4x >}}

:::: {.h5}
Posts with OECD FOS

::::: {.display-5}
[100%](https://rogue-scholar.org/search?q=references:*&l=list&p=1&s=10&sort=newest)
:::::
::::
:::

::: {.card .license}
{{< iconify fa-brands:creative-commons size=4x >}}

:::: {.h5}
Posts with Full-Text

::::: {.display-5}
[100%](https://rogue-scholar.org/search?q=&l=list&p=1&s=10&sort=newest)
:::::
::::
:::
...
::::: {.display-5}
[`{python} post_citation_count`](https://rogue-scholar.org/search?q=citations:*&l=list&p=1&s=10&sort=newest)
:::::
::::
:::
